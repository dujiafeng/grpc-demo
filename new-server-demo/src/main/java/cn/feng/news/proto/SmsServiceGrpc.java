...
public final class SmsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.SmsRequest,
      cn.feng.news.proto.SmsProto.SmsResponse> getSendSmsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendSms",
      requestType = cn.feng.news.proto.SmsProto.SmsRequest.class,
      responseType = cn.feng.news.proto.SmsProto.SmsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.SmsRequest,
      cn.feng.news.proto.SmsProto.SmsResponse> getSendSmsMethod() {
    io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.SmsRequest, cn.feng.news.proto.SmsProto.SmsResponse> getSendSmsMethod;
      ...
      synchronized (SmsServiceGrpc.class) {
        if ((getSendSmsMethod = SmsServiceGrpc.getSendSmsMethod) == null) {
          SmsServiceGrpc.getSendSmsMethod = getSendSmsMethod =
              io.grpc.MethodDescriptor.<cn.feng.news.proto.SmsProto.SmsRequest, cn.feng.news.proto.SmsProto.SmsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendSms"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.feng.news.proto.SmsProto.SmsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.feng.news.proto.SmsProto.SmsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.PhoneNumberRequest,
      cn.feng.news.proto.SmsProto.PhoneNumberResponse> getCreatePhoneMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createPhone",
      requestType = cn.feng.news.proto.SmsProto.PhoneNumberRequest.class,
      responseType = cn.feng.news.proto.SmsProto.PhoneNumberResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.PhoneNumberRequest,
      cn.feng.news.proto.SmsProto.PhoneNumberResponse> getCreatePhoneMethod() {
    io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.PhoneNumberRequest, cn.feng.news.proto.SmsProto.PhoneNumberResponse> getCreatePhoneMethod;
    if ((getCreatePhoneMethod = SmsServiceGrpc.getCreatePhoneMethod) == null) {
      synchronized (SmsServiceGrpc.class) {
        if ((getCreatePhoneMethod = SmsServiceGrpc.getCreatePhoneMethod) == null) {
          SmsServiceGrpc.getCreatePhoneMethod = getCreatePhoneMethod =
              io.grpc.MethodDescriptor.<cn.feng.news.proto.SmsProto.PhoneNumberRequest, cn.feng.news.proto.SmsProto.PhoneNumberResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createPhone"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.feng.news.proto.SmsProto.PhoneNumberRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.feng.news.proto.SmsProto.PhoneNumberResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.PhoneNumberRequest,
      cn.feng.news.proto.SmsProto.PhoneNumberResponse> getCreatePhoneAndSendMethod;
  ...
  public static io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.PhoneNumberRequest,
      cn.feng.news.proto.SmsProto.PhoneNumberResponse> getCreatePhoneAndSendMethod() {
    io.grpc.MethodDescriptor<cn.feng.news.proto.SmsProto.PhoneNumberRequest, cn.feng.news.proto.SmsProto.PhoneNumberResponse> getCreatePhoneAndSendMethod;
  ...
  public static abstract class SmsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendSms(cn.feng.news.proto.SmsProto.SmsRequest request,
        io.grpc.stub.StreamObserver<cn.feng.news.proto.SmsProto.SmsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendSmsMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<cn.feng.news.proto.SmsProto.PhoneNumberRequest> createPhone(
        io.grpc.stub.StreamObserver<cn.feng.news.proto.SmsProto.PhoneNumberResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getCreatePhoneMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<cn.feng.news.proto.SmsProto.PhoneNumberRequest> createPhoneAndSend(
        io.grpc.stub.StreamObserver<cn.feng.news.proto.SmsProto.PhoneNumberResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                cn.feng.news.proto.SmsProto.SmsRequest,
                cn.feng.news.proto.SmsProto.SmsResponse>(
                  this, METHODID_SEND_SMS)))
          .addMethod(
            getCreatePhoneMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                cn.feng.news.proto.SmsProto.PhoneNumberRequest,
                cn.feng.news.proto.SmsProto.PhoneNumberResponse>(
  ...
  public static final class SmsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SmsServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<cn.feng.news.proto.SmsProto.SmsResponse> sendSms(
        cn.feng.news.proto.SmsProto.SmsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_SMS:
          serviceImpl.sendSms((cn.feng.news.proto.SmsProto.SmsRequest) request,
              (io.grpc.stub.StreamObserver<cn.feng.news.proto.SmsProto.SmsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cn.feng.news.proto.SmsProto.getDescriptor();
    }
